...
import { GraduationCap, LayoutDashboard, FileEdit, User, LogOut, ChevronLeft, Menu } from "lucide-react"
...
const menuItems = [
  ...
  { id: "data-entry", label: "Submit Record", icon: FileEdit },
  { id: "profile", label: "My Profile", icon: User },
]

export function StudentSidebar({ currentView, setCurrentView, onLogout }: StudentSidebarProps) {
        ...
        <div className={cn("flex items-center gap-3 mb-3 px-3", collapsed && "justify-center")}>
          ...
          {!collapsed && (
            <div className="flex-1 min-w-0">
              ...
              <p className="text-xs text-sidebar-foreground/60 truncate">rahul@email.com</p>
            </div>
          )}
        </div>
        <Button
