...
const BASE_URL = ("TURBOPACK compile-time value", "https://warrantyindia.co.in/student/api");
const API_KEY = ("TURBOPACK compile-time value", "asdtfyghjklcghvhbjknlmfxcghbjknlmgcvhbjnkml");
async function getStudentListApi(page, limit, search = "") {
    const token = localStorage.getItem("auth_token");
    if (!token) throw new Error("Unauthorized");
    const res = await fetch(`${BASE_URL}/student/api/student_list?page=${page}&limit=${limit}&search=${search}`, {
        headers: {
...
const useStudentStore = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$MONTESSORI$2f$Montessori$2d$frontend$2f$node_modules$2f$zustand$2f$esm$2f$react$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["create"])((set, get)=>({
        ...
        fetchStudents: async ()=>{
            ...
            const res = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$MONTESSORI$2f$Montessori$2d$frontend$2f$services$2f$student$2e$service$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getStudentListApi"])(page, limit, search);
            set({
                loading: false,
                students: res.data,
...
//# sourceMappingURL=Desktop_MONTESSORI_Montessori-frontend_22df9251._.js.map