...
async function getSchoolsApi(SchoolName) {
    const url = SchoolName ? `${BASE_URL}/get_schools?SchoolName=${encodeURIComponent(SchoolName)}` : `${BASE_URL}/get_schools`;
...
function SchoolSelect({ value, onChange, placeholder = "Select school" }) {
    _s();
    const { schools, fetchSchools, resetSchools } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$MONTESSORI$2f$Montessori$2d$frontend$2f$store$2f$school$2e$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSchoolStore"])();
    const user = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$MONTESSORI$2f$Montessori$2d$frontend$2f$store$2f$auth$2e$store$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuthStore"])({
        "SchoolSelect.useAuthStore[user]": (state)=>state.user
    }["SchoolSelect.useAuthStore[user]"]);
    const prevSchoolNameRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$MONTESSORI$2f$Montessori$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const schoolNameFromLogin = user && user.SchoolName ? user.SchoolName.trim() : "";
    // ✅ ALWAYS re-fetch when SchoolName changes
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$MONTESSORI$2f$Montessori$2d$frontend$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SchoolSelect.useEffect": ()=>{
            // wait until auth is ready
            if (!user) return;
            // detect change ("" → value OR value → "")
            if (prevSchoolNameRef.current !== schoolNameFromLogin) {
                resetSchools();
                prevSchoolNameRef.current = schoolNameFromLogin;
                // 🔥 THIS FIXES YOUR ISSUE
                fetchSchools(schoolNameFromLogin);
            }
        }
    }["SchoolSelect.useEffect"], [
        user,
...
_s(SchoolSelect, "Ocvx1Qm4ohBsxHeTCjOEO20AFlU=", false, function() {
    return [
...
//# sourceMappingURL=Desktop_MONTESSORI_Montessori-frontend_5f40b3e3._.js.map